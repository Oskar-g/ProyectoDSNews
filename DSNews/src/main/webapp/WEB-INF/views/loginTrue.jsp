...
<html>
	<head>
		...
		<title><spring:message code="titulo.loginTrue" /></title>
		...
		<link rel="stylesheet" type="text/css" href="recursos/assets/css/main.css">
	</head>
		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<div id="main-wrapper">
					...
					<script>window.setTimeout('window.location="paginaAdmin";',100);</script>
							</article>
					</div>
				</div>
