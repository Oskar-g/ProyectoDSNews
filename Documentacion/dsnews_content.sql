...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2017 a las 14:22:39
...
CREATE TABLE `rss` (
  ...
  `link` text COLLATE utf8_spanish_ci NOT NULL,
  `section_id` int(11) NOT NULL,
  `periodico` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `rss` (`id`, `link`, `section_id`, `periodico`, `logo`) VALUES
...
(7, 'http://www.20minutos.es/rss/cultura/', 6, NULL, NULL),
(8, 'http://www.larazon.es/rss/religion.xml', 4, NULL, NULL),
(9, 'http://www.abc.es/rss/feeds/abc_Economia.xml', 3, NULL, NULL),
(10, 'http://www.lavanguardia.com/mvc/feed/rss/economia', 3, NULL, NULL),
(11, 'http://www.lefigaro.fr/rss/figaro_vox.xml', 6, NULL, NULL);
